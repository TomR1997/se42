...
public class ItemsFromSellerTest {
    ...
    final EntityManagerFactory emf = Persistence.createEntityManagerFactory("userPU");
    ...
    public void tearDown() throws Exception {
        DatabaseCleaner databaseCleaner = new DatabaseCleaner(registrationMgr.getEntityManager());
    ...
    public void numberOfOfferdItems() {
        ...
        assertNotEquals(0, user1.numberOfOfferdItems());
        ...
        assertNotEquals(3, userWithItem.numberOfOfferdItems());
        /*
         *  expected: which one of te above two assertions do you expect to be true?
         *  QUESTION:
         *    Explain the result in terms of entity manager and persistance context.
...
//    @Ignore
    ...
    @Test
    public void itemBidTest() {
        String email = "ifu1@nl";
        String emailb = "ss2@nl";
        String omsch = "omsch_bb";

        Category cat = new Category("cat2");
        User buyer = registrationMgr.getUser(emailb);
        User seller = registrationMgr.registerUser(email);
        Item item1 = sellerMgr.offerItem(seller, cat, omsch);
        assertNull(item1.getHighestBid());
        Bid new1 = auctionMgr.newBid(item1, buyer, new Money(9, "eur"));
        assertNotNull(item1.getHighestBid());
        Bid new2 = auctionMgr.newBid(item1, buyer, new Money(10, "eur"));
        assertEquals(new Money(10, "eur"), item1.getHighestBid().getAmount());
        Bid new3 = auctionMgr.newBid(item1, buyer, new Money(8, "eur"));
        assertNotEquals(new Money(10, "eur"), item1.getHighestBid());
    }
}
